...
const AdminMoviesList = () => {
  ...
  return (
    <div className="container mx-[9ren]">
                    ...
                    <div
                      ...
                      className="max-w-sm m-[2rem] rounded overflow-hidden shadow-lg">
                        ...
                        <div className="mt-[2rem] mb-[1rem]">
                          ...
                          className="bg-teal-500 hover:bg-teal-700 text-white font-bold py-2 rounded ">
                            Update Movie
                          </Link> */}
                          <div className="bg-teal-500 hover:bg-teal-700 text-white font-bold py-2 px-4 rounded text-center inline-block">
                        Update Movie
                      </div>
                        </div>
                      <div>
