...
const MoviesTabs = ({ userInfo, submitHandler, comment, rating, setRating,setComment, movie}) => {
  return (
    <div>
        <section>
            {userInfo ? (
              ...
              <select
                ...
                className="p-2 border rounded-lg text-black w-full md:w-[10rem]"
              >
                ...
                <option value="5">5 - Excellent</option>
                    ...
                    <div className="my-2">
                    <label htmlFor="comment" className="black text-xl mb-2">Write Your Review</label><br />
